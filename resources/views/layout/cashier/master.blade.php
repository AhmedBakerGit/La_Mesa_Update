...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="<?= $theme ?>">
        ...
        <div id="wrapper">
            ...
            @include('layout.cashier.navbar')
            @include('layout.cashier.sidebar')
                    ...
                    <div class="block-header">
                        <div class="row">
                            <div class="col-lg-5 col-md-8 col-sm-12">                        
                                ...
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><i class="icon-home"></i></a></li>
        ...
        @if (Request::segment(2) === 'menu' )
            <script src="{{ asset('assets/js/pages/cashier/menu.js') }}"></script>
        @endif
        ...
        <script src="{{ asset('assets/js/pages/cashier/orderNotification.js') }}"></script>
        <script src="{{ asset('assets/js/pages/cashier/requestNotification.js') }}"></script>

        @if (Request::segment(2) === 'orders' )
            <script src="{{ asset('assets/js/pages/cashier/orders.js') }}"></script>
        @endif

        @if (Request::segment(2) === 'request' )
            <script src="{{ asset('assets/js/pages/cashier/request.js') }}"></script>
        @endif

        @if (Request::segment(2) === 'bills' )
            <script src="{{ asset('assets/js/pages/cashier/bills.js') }}"></script>
        @endif
