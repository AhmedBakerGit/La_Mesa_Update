...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="<?= $theme ?>">
        ...
        <div id="wrapper">
            ...
            @include('layout.kitchen.navbar')
            @include('layout.kitchen.sidebar')
                ...
                <div class="container-fluid">
                    <div class="block-header">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-4 col-sm-12 text-left">
        ...
        @if (Request::segment(2) === 'menu' )
            <script src="{{ asset('assets/js/pages/kitchen/menu.js') }}"></script>
        @endif
        ...
        <script src="{{ asset('assets/js/pages/kitchen/orderNotification.js') }}"></script>

        @if (Request::segment(2) === 'orders' )
            <script src="{{ asset('assets/js/pages/kitchen/orders.js') }}"></script>
        @endif
