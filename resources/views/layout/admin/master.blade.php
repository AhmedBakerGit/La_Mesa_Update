...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        @if (Request::segment(2) === 'restcontent' )
    ...
    <body class="<?= $theme ?>">
        ...
        @if (Request::segment(2) === 'restaurants' )
            <script src="{{ asset('assets/js/pages/admin/restaurants.js') }}"></script>
        @endif


        @if (Request::segment(2) === 'restcontent' )
            <script src="{{ asset('assets/vendor/dropify/js/dropify.min.js') }}"></script>
            <script src="{{ asset('assets/js/pages/admin/restTable.js') }}"></script>
            <script src="{{ asset('assets/js/pages/admin/restMenu.js') }}"></script>
        @endif

        @if (Request::segment(2) === 'staff' )
            <script src="{{ asset('assets/js/pages/admin/staff.js') }}"></script>
        @endif
        ...
        @if (Request::segment(2) === 'sales' )
            <script src="{{ asset('assets/js/pages/admin/sales.js') }}"></script>
        @endif
        ...
        <script>
            // jQuery(function () {
                ...
                $('#id-restaurant-sidebar').click(function() {
